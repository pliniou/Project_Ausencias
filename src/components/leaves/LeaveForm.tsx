...
export function LeaveForm({ onSuccess }) {
    ...
    const [acquisitiveStart, setAcquisitiveStart] = useState();
    const [acquisitiveEnd, setAcquisitiveEnd] = useState();
    ...
    const onSubmit = (data) => {
        ...
        if (data.type === 'FERIAS') {
            const validation = validateVacationRule(
                ...
                data.startDate,
                daysOff,
                format(data.acquisitivePeriodStart, 'yyyy-MM-dd'),
                format(data.acquisitivePeriodEnd, 'yyyy-MM-dd')
            );
        ...
        addLeave({
            ...
            acquisitivePeriodStart: data.acquisitivePeriodStart ? format(data.acquisitivePeriodStart, 'yyyy-MM-dd') : null,
            acquisitivePeriodEnd: data.acquisitivePeriodEnd ? format(data.acquisitivePeriodEnd, 'yyyy-MM-dd') : null,
            daysOff,
        ...
        toast({
            ...
            description: `${employee.name} - ${leaveTypeLabels[data.type]}`,
        });

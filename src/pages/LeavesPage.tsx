...
import { LeaveFilters, initialFilters } from '@/components/leaves/LeaveFilters';
...
export default function LeavesPage() {
    ...
    const endedLeavesRaw = leaves.filter((l: any) => l.status === 'ENCERRADO');

    const basicFilter = (l: any) => {
                ...
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        onClick={() => {
                            ...
                            const content = allLeaves.map((l: any) => {
                                const type = leaveTypeLabels[l.type as keyof typeof leaveTypeLabels] || l.type;
...
function LeaveGrid({ leaves, viewMode, onDelete }: { leaves: any[], viewMode: string, onDelete: (id: string) => Promise<void> }) {
    return (
